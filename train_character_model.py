...
def main():
    parser = argparse.ArgumentParser(
        description='Train Character Recognition Model at 104Hz'
    )
    
    # Data arguments
    parser.add_argument('--dataset', type=str, default='synthetic',
                       choices=['synthetic', 'onhw', 'csv'],
                       help='Dataset to use for training')
    parser.add_argument('--data-path', type=str, default='./data',
                       help='Path to dataset')
    parser.add_argument('--download', action='store_true',
                       help='Download OnHW dataset if not found')
    
    # Model arguments
    parser.add_argument('--timesteps', type=int, default=512,
                       help='Timesteps per sample (at sampling_rate Hz)')
    parser.add_argument('--features', type=int, default=13,
                       help='Number of sensor features')
    parser.add_argument('--num-classes', type=int, default=26,
                       help='Number of output classes (A-Z)')
    parser.add_argument('--sampling-rate', type=int, default=104,
                       help='Sensor sampling rate (Hz)')
    ...
    parser.add_argument('--output-dir', type=str, default='./src/ai/models',
