...
def test_data_flow():
    ...
    try:
        ...
        for i in range(50):
            ...
            top_accel = {'x': sample_data['top_accel_x'], 'y': sample_data['top_accel_y'], 'z': sample_data['top_accel_z']}
            rear_accel = {'x': sample_data['rear_accel_x'], 'y': sample_data['rear_accel_y'], 'z': sample_data['rear_accel_z']}
            top_gyro = {'x': sample_data['top_gyro_x'], 'y': sample_data['top_gyro_y'], 'z': sample_data['top_gyro_z']}
            rear_gyro = {'x': sample_data['rear_gyro_x'], 'y': sample_data['rear_gyro_y'], 'z': sample_data['rear_gyro_z']}
